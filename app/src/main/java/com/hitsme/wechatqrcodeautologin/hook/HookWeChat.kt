           ...
           XposedHelpers.findAndHookMethod(loginClass, "onCreate", Bundle::class.java, object : XC_MethodHook() {
            ...
            override fun beforeHookedMethod(param: MethodHookParam) {
              ...
              //  Toast.makeText(activity, "budle的键"+i+"键值为"+budl.getString(i), Toast.LENGTH_SHORT).show()
                ...
                Toast.makeText(activity, "Oncreate budle的键", Toast.LENGTH_SHORT).show()
                val intent3 = Intent()
                intent3.putExtra("rawUrl", "http://mp.weixin.qq.com/wap/loginauthqrcode?action=scan&qrticket=182a0a0fa5c0e99597e7610c31e80c98#wechat_redirect")
                intent3.putExtra("useJs", true)
                intent3.putExtra("srcUsername", "wxid_zftaoa1bsgjd21")
                intent3.putExtra("bizofstartfrom", "enterpriseHomeSubBrand")
             intent3.addFlags(67108864)
                intent3.setClassName(activity,"com.tencent.mm.plugin.webview.ui.tools.WebViewUI")
